...
PERFORMANCE_FLAGS = -O2 -march=$(MARCH) -Winline -Wdisabled-optimization -Wpadded -ftree-vectorize # vectorize is the only thing from O3 that we want
...
LIB_FLAGS_EXTERN = $(LIB_FLAGS) -L ./lib -lpqr
